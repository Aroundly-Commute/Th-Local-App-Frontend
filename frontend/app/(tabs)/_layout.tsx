...
import { Home, Search, Car, User, MapPin, ShoppingBag, Users, MessageCircle } from 'lucide-react-native';
...
export default function TabsLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="messages" options={{ title: 'Messages', tabBarIcon: ({ color, size }) => <MessageCircle color={color} size={size - 2} strokeWidth={2} /> }} />
