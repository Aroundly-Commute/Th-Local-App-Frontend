...
import { ChevronLeft, Plus, Check, X, Calendar, DollarSign, Clock, MapPin, User as UserIcon } from 'lucide-react-native';
...
export default function ManageParking() {
  ...
  const [dateInput, setDateInput] = useState('2026-05-22');
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: t.background }}>
      ...
      <View style={[styles.header, { borderBottomColor: t.border }]}>
        ...
        <View style={{ flex: 1, marginLeft: 8 }}>
          <Text style={[styles.headerTitle, { color: t.textPrimary }]}>Manage My Parking</Text>
          <Text style={[styles.headerSub, { color: t.textSecondary }]}>
            Plan slots, view earnings, and manage booking requests
          </Text>
        </View>
      </View>
